...
import com.matchschedules.sub.submission2_matchschedules.model.Team
...
class fAVMatchDetailActivity : AppCompatActivity(), DetailView {

    private lateinit var presenter: DetailPresenter
    private lateinit var progressBar: ProgressBar
    private var isFavorite: Boolean = false
    private var menuItem: Menu? = null
    private lateinit var event: FavoriteMatch
    ...
    private fun initData(matchEvent: FavoriteMatch) {
